...
![Render of the isolated rear rotor]({{ "/assets/images/rotor_alone.png" | relative_url }}){: style="display: block; width: 400px; height: auto; margin: 20px auto;"}
...
For the rotor's design criteria, it was determined that due to thermal expansion risk, the rotor must stay below $T_{max}=300^\circ C$. For ambient temperature, I will use the worst case scenario: during our competition in Arizona, the temperature reached $T_{amb} = 40^\circ C$

Another question I would like to answer is the question of how much energy is dissipated from the car when the rear brake is dragging. Previously, we have observed the rear brake rotor glowing red. This represents a temperature (in stainless steel) of about $T_{hot}= 600^\circ C$
